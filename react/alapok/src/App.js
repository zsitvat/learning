...
function App(){
  return React.createElement(
      ...
      "App",
      React.createElement(BoxComponent3 ,{ hatterSzin: "red", felirat: "BOX1" , szam: 0}),
      React.createElement(BoxComponent3, { hatterSzin: "blue", felirat: "BOX2" , szam: 10}),
      React.createElement(BoxComponent3, {hatterSzin: "green",felirat: "BOX3", szam: 20}),
      <Aktivalas/>
      );
}
...
function BoxComponent3(props){
  ...
  return <div 
     style={{backgroundColor: props.hatterSzin,width: "100px",height: "100px"}}
      className="box p-2 m-5 rounded"
...
function Aktivalas(props){
  ...
  <div className='border'>
    <Box props={{isActive:isActive}}/>
    <ButtonComponent props={{isActive:isActive,setActive:setActive}}/>
     App szintű state:  
...
function Box(props){
  return (<div style={{width:"200px",height:"200px",backgroundColor: (props.isActive ? "green" : "firebrick")}}> {props.isActive ? "Aktív" : "Inaktív"}</div>)
}
